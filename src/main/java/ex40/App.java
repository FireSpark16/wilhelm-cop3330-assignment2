...
public class App {
    ...
    public static void main(String[] args) {
        ...
        String filter = myApp.getInput();

        myApp.output(data, filter);
    ...
    public void output(ArrayList<Map> data, String filter) {
        ...
        {
            if (data.get(i).get("First Name").toString().contains(filter) || data.get(i).get("Last Name").toString().contains(filter)) {
